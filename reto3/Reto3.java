...
class Reto3 {
    ...
    public void run() {
        ...
        if (mensaje == true) {
            System.out.println(bd.generarInforme()[0]+" "+bd.generarInforme()[1]
                    +" "+String.format("%.1f",Double.parseDouble(bd.generarInforme()[2])));
        } else {
...
//    }
    ...
    public String promedioInvetario() {
        Stream<Producto> st = this.listaProductos.values().stream();
        int tam=this.listaProductos.values().size();                        
    ...
    public String[] generarInforme() {        
        ...
        datos[0] = this.mayorInvetario();
        datos[1] = this.menorInventario();
        datos[2] = this.promedioInvetario();
        return datos;
    }
